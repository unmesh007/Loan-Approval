...
def create_pdf(name, app_vals, pred_text, risk, conditions):
    ...
    try:
        ...
        pdf.cell(200, 10, txt="Comprehensive Loan Analysis Report", new_x="LMARGIN", new_y="NEXT", align='C')
        pdf.set_font("Arial", size=12)
        pdf.cell(200, 10, txt="--------------------------------------------------", new_x="LMARGIN", new_y="NEXT", align='C')
        pdf.cell(200, 10, txt=f"Applicant Name/ID: {name}", new_x="LMARGIN", new_y="NEXT")
        pdf.cell(200, 10, txt=f"Prediction: {pred_text} | Risk Level: {risk}", new_x="LMARGIN", new_y="NEXT")
        pdf.cell(200, 10, txt="Conditions:", new_x="LMARGIN", new_y="NEXT")
        for c in conditions: pdf.cell(200, 8, txt=f" - {c}", new_x="LMARGIN", new_y="NEXT")
        
        pdf.image(gauge_file, x=10, y=80, w=80)
        pdf.image(radar_file, x=100, y=80, w=100)
        
        pdf.add_page()
        pdf.cell(200, 10, txt="Visual Context & AI Transparency", new_x="LMARGIN", new_y="NEXT", align='C')
